"""
    ...
    This module handles connections to discord. It
    written because existing library more suitable
    for bots (some calls aren't implemented) and
    we only need a small subset of calls.
"""
